...
\begin{tikzpicture}[scale=1]
  ...
  \draw[fill=white] (0*\X, \YA) node{\textbf{1}} +(-5pt, -5pt) rectangle +(5pt, 5pt);
  \draw[fill=white] (0*\X, \YB) node{\textbf{2}} +(-5pt, -5pt) rectangle +(5pt, 5pt);
  ...
  5+\YA) -- node[anchor=south, yshift=10pt]{$B$}
  (6*\X, 5+\YA);
  ...
  \draw[->, dashed] ( 6*\X, \YA ) -- node[sloped, above]{$B$} (7*\X, \YB);
