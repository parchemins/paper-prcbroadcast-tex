...
\begin{figure*}
  \begin{center}
    ...
    and deliver $a$. They both expect an additional copy of the message $a$.]
    ...
    of $a$. Process~B and Process~C do not expect additional copies of the message $a$. 
...
\begin{figure*}
  \begin{center}
    ...
    and forwards $a$ a second time, but the number of expected copies becomes
    inconsistent and may grow unbounded.]
