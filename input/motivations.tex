...
\begin{figure*}
  \begin{center}
    \begin{subfigure}
      ...
      \caption{\label{fig:generalpurgeA}Process~A broadcasts $a$. It expects 
        two copies of the message $a$.}
    \end{subfigure}
    \hspace{10pt}
    \begin{subfigure}
      \input{input/figgeneralpurgeB.tex}
      \caption{\label{fig:generalpurgeB}Process~B and Process~C receive
    ...
    \begin{subfigure}
      ...
      \caption{\label{fig:generalpurgeC}Process~B and Process~C forward $a$ 
        to their neighbors in a gossip fashion.}
    \end{subfigure}
    \hspace{10pt}
    \begin{subfigure}
      \input{input/figgeneralpurgeD.tex}
      \caption{\label{fig:generalpurgeD}Process~A and Process~C receive a copy
    ...
    \begin{subfigure}
      ...
      \caption{\label{fig:generalpurgeE}Process~A receives the last 
