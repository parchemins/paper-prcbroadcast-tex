...
\begin{figure*}
  \begin{center}
    \subfloat[Part A][\label{fig:solveA}
    Process~B adds a link to Process~C. \RPCBROADCAST ensures its
    safety. Process~B sends a first control message $\alpha$ to Process~C using
    Process~A as mediator.]
    {\input{input/figsolveA.tex}}
    \hspace{10pt}
    \subfloat[Part B][\label{fig:solveB}
    Process~A receives $\alpha$ and routes it to Process~C.]
    {\input{input/figsolveB.tex}}
    \hspace{10pt}
    \subfloat[Part C][\label{fig:solveC}
    Process~C receives $\alpha$ and answers by sending $\beta$ 
    ...
    \hspace{10pt}
    \subfloat[Part D][\label{fig:solveD}
    Process~A receives $\beta$ and routes it to Process~B. 
    Process~A receives $c_1$ and forwards it to both its neighbors.]
    {\input{input/figsolveD.tex}}
    \hspace{10pt}
    \subfloat[Part E][\label{fig:solveE}
    Process~C receives and discards $c_1$. 
    ...
    \hspace{10pt}
    \subfloat[Part F][\label{fig:solveF}
    Process~A receives $c_1$ and discards it.
    ...
    \hspace{10pt}
    \subfloat[Part G][\label{fig:solveG}
    Process~A receives $c_2$ and forwards it to its neighbors.
    ...
    \hspace{10pt}
    \subfloat[Part H][\label{fig:solveH}
    Process~A receives and discards $b_1$. 
    ...
    \hspace{10pt}
    \subfloat[Part I][\label{fig:solveI}
    Once Process~A sent $B_\beta$, the new link is safe.
    ...
    %\hspace{10pt}
    \subfloat[Part J][\label{fig:solveJ}
    Process~C categorizes each message of $B_\beta$ using its two 
