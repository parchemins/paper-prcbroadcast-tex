...
following causal order. However, \PCBROADCAST does not forbid multiple delivery
by itself. It relies on a reliable broadcast that either use vector clocks, or
fails to handle dynamic systems (see Figure~\ref{fig:counterproblem}).
