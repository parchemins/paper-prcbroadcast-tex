...
\TODO{Not good, for expected message are local...}
...
\begin{figure}
  ...
  \caption{\label{fig:problemstatement} For each message in the buffer, the protocol must be able to identify its category. \TODO{Not good because of expected messages.}}
\end{figure}
