...
\begin{tikzpicture}[scale=1]
  ...
  \draw (0*\X, \RADY*\Y) node[below]{\textbf{\uline{Delivered by Process~A}}};
  ...
  \draw (\RADX*\X, \RADY*\Y) node[below]{\textbf{\uline{Delivered by Process~B}}};
\end{tikzpicture}
