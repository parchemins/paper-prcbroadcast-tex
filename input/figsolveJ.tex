...
\begin{tikzpicture}[scale=0.9]
  ...
  \draw (0*\X, \RADY*\Y) node[below]{\textbf{\COLOR{blue!80!black!70}{\uline{Delivered by Process~B}}}};
  ...
  \draw (0.5*\RADX*\X, 0pt) node[align=center] {
    ...
    \COLOR{purple}{$\{ b_1,\, c_2 \}$}
  };
  \draw (\RADX*\X, 0pt) circle [x radius=\RADX*\X, y radius = \RADY*\Y];
  \draw (\RADX*\X, \RADY*\Y) node[below]{\textbf{\COLOR{red!80!black!70}{\uline{Delivered by Process~C}}}};
\end{tikzpicture}
