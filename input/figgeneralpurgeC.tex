...
\begin{tikzpicture}[scale=1]
  ...
  \draw (0*\X, 5+0*\Y) node[above]{$E: \{a:2\}$};
  ...
  \draw (2*\X, 5-0*\Y) node[above]{$E:\{a:1\}$};

  \draw[->](5+0*\X, 0*\Y) -- (-5+1*\X, -1*\Y); %% A->B
  \draw[<-](5+0*\X, -5+0*\Y) -- node[sloped, below]{$\,\,\,\,\,\,\,\bm{a}$} (-5+1*\X, -5-1*\Y); %% A<-B

  \draw[->](5+0*\X, 5+0*\Y) -- (-5+2*\X, 5+0*\Y); % A->C
  \draw[<-](5+0*\X,  1.25+ 0*\Y) -- node[below]{$\,\,\,\,\bm{a}$} (-5+2*\X,  1.25+ 0*\Y); % A<-C
 
  \draw[->](5+1*\X, -1*\Y) -- node[sloped,below]{$\bm{a}$} (-5+2*\X, 0*\Y); %% B<-C
  % \draw[->](5+1*\X, -5-1*\Y) -- node[sloped,below]{$\bm{a}\,\,\,\,\,\,\,$}(-5+2*\X, -5+0*\Y); %% B->C
