...
\begin{abstract}
  ...
  constant. Local space complexity is not monotonically increasing and depends
  on system settings and use. We prove that all and only obsolete control
  information is safely discarded, at cost of a few lightweight control
  messages.  Our implementation constitutes a sustainable communication
