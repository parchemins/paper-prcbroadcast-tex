...
\begin{tikzpicture}[scale=1]
  ...
  \draw (\OFFX-\RADX*\X, 0pt) node[right, align=left] {
    ...
    $B_\beta \setminus B_\alpha \setminus B_\pi$\\\footnotesize
    $[c_1,\,b_1,\,b_2,\,c_2]\setminus\{c_1,\,c_2\}\setminus\{b_1,\,c_3\}$\\\footnotesize
  ...
  \draw (-\OFFX+2*\RADX*\X, 0pt) node[left, align=right] {
    ...
    $B_\pi \setminus B_\beta$\\\footnotesize
  ...
  \draw (0.5*\RADX*\X, 0pt) node[align=center] {
    ...
    $B_\beta \wedge (B_\alpha \cup B_\pi)$\\\footnotesize
    $[c_1,\,b_1,\,b_2,\,c_2] \wedge (\{c_1,\,c_2\} \cup \{ b_1,\,c_3\})$\\\footnotesize
