...
% Since each link eventually carries each message once, a process receiving a
% message from a link knows that it will never receive this message from this link
% again.
...
\begin{theorem}[Link memory forbids multiple delivery]
  % Every process maintaining link memory delivers each broadcast message
  % exactly once.
