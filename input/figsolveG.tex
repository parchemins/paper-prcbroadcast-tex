...
\begin{tikzpicture}[scale=1]
  ...
  \draw (5+ 1*\X, -5-1*\Y) node[below right]{$B_\beta: [b_1,\,b_2 ]$};
  ...
  \draw[<-](5+0*\X, -5+0*\Y) -- node[below, sloped]{~~~~~~~~ $b_2$} (-5+1*\X, -5-1*\Y); %% A<-B
  
  \draw[->](5+0*\X, 5+0*\Y) -- node[above]{$c_2$ ~~~~~~} (-5+2*\X, 5+0*\Y); % A->C
  \draw[<-](5+0*\X,  1.25+ 0*\Y) -- node[below]{~~~ $\rho$ ~~ $b_1$ $c_3$} (-5+2*\X,  1.25+ 0*\Y); % A<-C
